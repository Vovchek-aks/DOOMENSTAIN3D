...
map_obj = [
    {
        ...
        'zombie': [(4 * rect_size2d // 4, 2 * rect_size2d // 4), (8 * rect_size2d // 4, 2 * rect_size2d // 4),
                   (2 * rect_size2d // 4, 6 * rect_size2d // 4), (3.5 * rect_size2d // 4, 6.8 * rect_size2d // 4),
                   (8 * rect_size2d // 4, 3 * rect_size2d // 4)],
        'spawner': [],
        'door': [(7 * rect_size2d // 4, 7.5 * rect_size2d // 4,
                  [(7 * rect_size2d // 4, 7 * rect_size2d // 4)], -1), (8 * rect_size2d // 4, 5.5 * rect_size2d // 4,
                  [(8 * rect_size2d // 4, 4 * rect_size2d // 4)], 1)],
        'key': [(2 * rect_size2d // 4, 2 * rect_size2d // 4, 1)],
    ...
    {
        'player': (3.5 * rect_size2d // 4, 2 * rect_size2d // 4),
        'spider': [(11 * rect_size2d // 4, 5.5 * rect_size2d // 4), (7 * rect_size2d // 4, 4.5 * rect_size2d // 4),
                   (12.5 * rect_size2d // 4, 7 * rect_size2d // 4)],
        'zombie': [(4 * rect_size2d // 4, 8 * rect_size2d // 4), (14.5 * rect_size2d // 4, 6 * rect_size2d // 4),
                   (6 * rect_size2d // 4, 5 * rect_size2d // 4), (7 * rect_size2d // 4, 7 * rect_size2d // 4)],
        'spawner': [],
        'door': [(1.5 * rect_size2d // 4, 7 * rect_size2d // 4,
                  [(1 * rect_size2d // 4, 7 * rect_size2d // 4)], 0), (14 * rect_size2d // 4, 1.5 * rect_size2d // 4,
                  [(14 * rect_size2d // 4, 1 * rect_size2d // 4)], 2)],
        'key': [(6 * rect_size2d // 4, 2 * rect_size2d // 4, 2), (9 * rect_size2d // 4, 7 * rect_size2d // 4, 0)],
        'trigger': [(15 * rect_size2d // 4, 7 * rect_size2d // 4, 'next_level')],
        'spr': [(15 * rect_size2d // 4, 8 * rect_size2d // 4, "obj_spr['portal']")],
        'aptechka': [],
        'patroni': [(1.5 * rect_size2d // 4, 2 * rect_size2d // 4, 1), (1.5 * rect_size2d // 4, 3 * rect_size2d // 4, 1),
                   (1.5 * rect_size2d // 4, 4 * rect_size2d // 4, 1), (1.5 * rect_size2d // 4, 5 * rect_size2d // 4, 1)],
    },
    {
        ...
        'key': [(13 * rect_size2d // 4, 4 * rect_size2d // 4), (5.5 * rect_size2d // 4, 3.5 * rect_size2d // 4),
                (23 * rect_size2d // 4, 10.5 * rect_size2d // 4)],
    ...
    },
    {
        ...
        'spider': [(3.5 * rect_size2d // 4, 2 * rect_size2d // 4), (2 * rect_size2d // 4, 2 * rect_size2d // 4)],
        'zombie': [],
        'spawner': [(5 * rect_size2d, 1 * rect_size2d, 'Zombie', [(5 * rect_size2d, 2 * rect_size2d)], 3),
                    (3.5 * rect_size2d // 4, 5 * rect_size2d // 4, 'Spider', [(2.5 * rect_size2d // 4, 4.5 * rect_size2d // 4)], 3),
                    (3.5 * rect_size2d // 4, 4 * rect_size2d // 4, 'Zombie', [(2.5 * rect_size2d // 4, 4.5 * rect_size2d // 4)], 3),
                    (3.5 * rect_size2d // 4, 4 * rect_size2d // 4, 'Zombie', [(2.5 * rect_size2d // 4, 4.5 * rect_size2d // 4)], 3),
                    (3.5 * rect_size2d // 4, 4 * rect_size2d // 4, 'Zombie', [(2.5 * rect_size2d // 4, 4.5 * rect_size2d // 4)], 3),
                    (3.5 * rect_size2d // 4, 4 * rect_size2d // 4, 'Zombie', [(2.5 * rect_size2d // 4, 4.5 * rect_size2d // 4)], 3),
                    (3.5 * rect_size2d // 4, 4 * rect_size2d // 4, 'Zombie', [(2.5 * rect_size2d // 4, 4.5 * rect_size2d // 4)], 3),
